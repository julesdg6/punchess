...
BOT_NAME = os.getenv("PUNCHESS_BOT_NAME", "python-chess-bot")
...
def main() -> None:
    register = requests.post(
        ...
        json={"name": BOT_NAME, "metadata": {"template": "python", "strategy": "chess"}},
    )
    ...
    while True:
        ...
        resp = requests.post(
            ...
            json={"agent_id": agent_id, "move": move, "debug": {"source": "python_chess"}},
        )
